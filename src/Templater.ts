...
type AST = string[];
type TemplateCache = Map<Template, AST>;
type TemplateKeys = Set<string>;
type Result = string;
...
export class Templater {
    ...
    async parseTemplateRegex(template: Template): Promise<AST> {
    ...
    async compileToString(template: Template, data: Data) {
    ...
    async compileToStringDSA(template: Template, data: Data) {
        const ast = await this.parse(template);
    ...
    async compileFileToString(path: string, data: Data) {
